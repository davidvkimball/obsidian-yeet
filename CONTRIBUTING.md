...
- This plugin publishes the active note's contents to the yeet.md service when you explicitly run the publish command; it makes no other network requests.
